          ...
          <div className="flex mt-4 md:mt-0">
            <div className="flex flex-col">
              ...
              <p className="pt-10 text-xl">
                <Link href="https://maps.app.goo.gl/UappjGQQoEHy8CZw6" className="underline-onhover text-[#FFA1DF] hover:text-white" target="_blank" rel="noopener noreferrer" title="Open in Google Maps">
          ...
          <div className="flex mt-4 md:mt-0">
            <div className="flex flex-col">
              ...
              <div className='flex mt-4 md:mt-0 gap-9'>
                <Link href="https://www.linkedin.com/in/denkminds/" className='hover:text-[#FFA1DF]' target="_blank" rel="noopener noreferrer" title="Follow us on LinkedIn">
                  <FontAwesomeIcon icon={faLinkedin} size="2x" />
                </Link>
                <Link href="https://x.com/denkminds" className='hover:text-[#FFA1DF]' target="_blank" rel="noopener noreferrer" title="Follow us on Twitter">
                  <FontAwesomeIcon icon={faXTwitter} size="2x" />
                </Link>
                <Link href="mailto:denkminds@gmail.com" className='hover:text-[#FFA1DF]' target="_blank" rel="noopener noreferrer" title="Send us an email">
