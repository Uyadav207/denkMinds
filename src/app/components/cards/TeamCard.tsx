...
const TeamCard: React.FC<TeamCardProps> = ({
  ...
  <div className="group flex flex-col w-full overflow-hidden mb-9 mx-auto border-1 border-r border-gray-700 border-t-0 border-b-0 bg-transparent text-center transition-all duration-300 hover:bg-[#272278] hover:bg-opacity-20 p-5">
